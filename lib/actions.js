...
var DOMAIN = (exports.DOMAIN = 'react-datatable-bs');
...
var dataFilter = (exports.dataFilter = function dataFilter(
  key,
  value,
  filters,
  table,
...
var pageNumberChange = (exports.pageNumberChange = function pageNumberChange(
  pageNumber,
  table,
) {
  return {
...
var pageSizeChange = (exports.pageSizeChange = function pageSizeChange(
  pageSize,
  table,
) {
  return {
